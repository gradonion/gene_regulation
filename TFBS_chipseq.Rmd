...
## New mRNA expression data: Geuvadis database
...
We focus on the 14102 genes that are shared between both the Battle dataset and the Geudavis dataset.   
For each TF, we calculate the correlation ($R^2$) of its expression level with each one of the 14102 genes, using the Geudavis dataset first and the Battle dataset next. We plot the $R^2$s obtained from the first dataset in increasing order (red), and then plot the $R^2$s obtained from the first dataset for the corresponding genes (light blue), as we expect to see some level of correlation between these two groups of $R^2$s. We then further calculated the correlation coefficient of these two groups of $R^2$s.
...
plot(1:length(tmp$rsquare),tmp$rsquare[order(tmp$rsquare_462)],type = "l", col="lightblue",main = title, xlab="genes in order",ylab=expression('R'^2*' values'), ylim=c(0,0.65))
lines(1:length(tmp$rsquare),tmp$rsquare_462[order(tmp$rsquare_462)], col="red")
legend(x=10000,y=0.6,lty=1,col=c("lightblue","red"),legend = c("Battle70,-2PCs","GD462"),cex=0.8)

sum_lm = summary(lm(tmp$rsquare~tmp$rsquare_462))
print(paste("Correlation btw the 2 groups of R^2\'s:",round(sum_lm$r.squared,digits = 4)))
```
...
title = paste(TF,"~ all genes R2 generated from 70 & 462 cell lines")
plot(1:length(tmp$rsquare),tmp$rsquare[order(tmp$rsquare_462)],type = "l", col="lightblue",main = title, xlab="genes in order",ylab=expression('R'^2*' values'), ylim=c(0,0.6))
lines(1:length(tmp$rsquare),tmp$rsquare_462[order(tmp$rsquare_462)], col="red")
legend(x=10000,y=0.6,lty=1,col=c("lightblue","red"),legend = c("Battle70,-2PCs","GD462"),cex=0.8)
...
title = paste(TF,"~ all genes R2 generated from 70 & 462 cell lines")
plot(1:length(tmp$rsquare),tmp$rsquare[order(tmp$rsquare_462)],type = "l", col="lightblue",main = title, xlab="genes in order",ylab=expression('R'^2*' values'), ylim=c(0,0.7))
lines(1:length(tmp$rsquare),tmp$rsquare_462[order(tmp$rsquare_462)], col="red")
legend(x=10000,y=0.7,lty=1,col=c("lightblue","red"),legend = c("Battle70,-2PCs","GD462"),cex=0.8)
...
title = paste(TF,"~ all genes R2 generated from 70 & 462 cell lines")
plot(1:length(tmp$rsquare),tmp$rsquare[order(tmp$rsquare_462)],type = "l", col="lightblue",main = title, xlab="genes in order",ylab=expression('R'^2*' values'), ylim=c(0,0.55))
lines(1:length(tmp$rsquare),tmp$rsquare_462[order(tmp$rsquare_462)], col="red")
legend(x=10000,y=0.55,lty=1,col=c("lightblue","red"),legend = c("Battle70,-2PCs","GD462"),cex=0.8)
...
### Strong Enhancers
We use the annotations from the ChromHmm file [wgEncodeBroadHmmGm12878HMM.bed.gz][chromm] to define the "strong enhancer" regions on the human reference genome (_hg19_) in LCL cell line _GM12787_.

[chromm]: http://rohsdb.cmb.usc.edu/GBshape/cgi-bin/hgTrackUi?db=hg19&g=wgEncodeBroadHmm

### Correlation Analysis

* STAT1, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "STAT1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* STAT1, target genes: ChIP-seq peaks in ChromHmm "strong enhancers"in Hi-C contact with promoter regions
```{r echo=FALSE}
TF = "STAT1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* YY1, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "YY1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* YY1, target genes: ChIP-seq peaks in ChromHmm "strong enhancers" that are in contact with promoter regions through Hi-C 
```{r echo=FALSE}
TF = "YY1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* CEBPB, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "CEBPB"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
target = read.table(filename, header = FALSE, na.strings = 'NA', stringsAsFactors = FALSE)
  ...
  hist_0 = hist(r_sq, breaks = hist_1$breaks,plot = FALSE)
  hist_0$density = hist_0$counts/sum(hist_0$counts)*100
  hist[[1]] = hist_0
  hist[[2]] = hist_1
  
title = paste0("[",TF," ~ Target] vs [",TF,"~ Non-target] GD462 R2")
plot(hist[[1]]$mids, hist[[1]]$density, xlim = c(0,0.28), ylim = c(0,80), type = "o", col = "red",
     main = title, xlab = expression("R"^2), ylab = "Density (%)")
lines(hist[[2]]$mids, hist[[2]]$density,  type = "o", col = "blue")
# mtext("target genes: linked by HiC through top 10% peaks in DHS & H3K27ac", col = "gray30")
mtext("target genes: peaks overlap w/ 3kb promoters", col = "gray30")
...
* CEBPB, target genes: ChIP-seq peaks in ChromHmm "strong enhancers" that are in contact with promoter regions through Hi-C 
```{r echo=FALSE}
TF = "CEBPB"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* SP1, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "SP1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* SP1, target genes: ChIP-seq peaks in ChromHmm "strong enhancers" that are in contact with promoter regions through Hi-C 
```{r echo=FALSE}
TF = "SP1"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* NFYA, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "NFYA"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* NFYA, target genes: ChIP-seq peaks in ChromHmm "strong enhancers" that are in contact with promoter regions through Hi-C 
```{r echo=FALSE}
TF = "NFYA"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* IRF4, target genes: ChIP-seq peaks in 3kb promoter regions
```{r echo=FALSE}
TF = "IRF4"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
...
* IRF4, target genes: ChIP-seq peaks in ChromHmm "strong enhancers" that are in contact with promoter regions through Hi-C 
```{r echo=FALSE}
TF = "IRF4"
filename = paste0('~/Downloads/Research/LCL/',TF,'_all_genes_R2_GD462.txt')
R_sq = read.table(filename, sep = "\t", header = FALSE, row.names = 1, na.strings = 'NA', 
